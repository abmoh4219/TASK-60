...
-- ── Orders ────────────────────────────────────────────────────────────────────
INSERT INTO orders (id, order_number, passenger_id, schedule_id, seat_class_id, seat_number, status, fare_amount, created_by)
VALUES
    ('50000000-0000-0000-0000-000000000001', 'ORD-00001',
     '40000000-0000-0000-0000-000000000001',
     '30000000-0000-0000-0000-000000000001',
     '20000000-0000-0000-0000-000000000001', '14C', 'confirmed', 49.00,
     '00000000-0000-0000-0000-000000000003'),
    ('50000000-0000-0000-0000-000000000002', 'ORD-00002',
     '40000000-0000-0000-0000-000000000002',
     '30000000-0000-0000-0000-000000000001',
     '20000000-0000-0000-0000-000000000002', '2A', 'confirmed', 119.00,
     '00000000-0000-0000-0000-000000000003'),
    ...
    ('50000000-0000-0000-0000-000000000004', 'ORD-00004',
     ...
     '30000000-0000-0000-0000-000000000005',
     '20000000-0000-0000-0000-000000000003', '1B', 'confirmed', 249.00,
     '00000000-0000-0000-0000-000000000002'),
    ('50000000-0000-0000-0000-000000000005', 'ORD-00005',
     '40000000-0000-0000-0000-000000000005',
     '30000000-0000-0000-0000-000000000007',
     '20000000-0000-0000-0000-000000000005', '8F', 'cancelled', 79.00,
     '00000000-0000-0000-0000-000000000003')
ON CONFLICT DO NOTHING;
